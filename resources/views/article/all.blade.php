    ...
    <div class="flex justify-center items-center px-[5rem] pt-[10rem]">
        <div>
            <div class="relative flex justify-between items-center">
                ...
                <div class="absolute flex flex-col glass-morph top-[3rem] right-0 mt-2 max-h-48 overflow-y-auto w-60 rounded shadow-lg p-3 transition-all z-50 opacity-100 text-right"
                    id="dropdown-menu2">
